...
$passenger_id = $_SESSION['passenger_id']; // Use session to get passenger_id
...
// Fetch user data (including profile picture and username)
$stmt = $pdo->prepare("SELECT profile_pic, username FROM passenger WHERE passenger_id = :id");
...
$passenger_name = htmlspecialchars($user['username'] ?? '');
?>
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel">
  ...
  <div class="offcanvas-body">
    ...
    <ul class="list-unstyled">
      ...
      <li><a href="#" class="d-block py-2 text-danger" data-bs-toggle="modal" data-bs-target="#logoutModal"><i class="fas fa-sign-out-alt me-2"></i> Logout</a></li>
    </ul>
  </div>
</div>
