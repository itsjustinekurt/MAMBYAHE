...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="complaineeModalLabel">Complainee Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p id="complaineeName"></p>
                    <p id="complaineeType"></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        // Handle complainee link clicks
        document.querySelectorAll('.complainee-link').forEach(link => {
            link.addEventListener('click', function(e) {
                e.preventDefault();
                const modal = new bootstrap.Modal(document.getElementById('complaineeModal'));
                
                // Set modal content
                document.getElementById('complaineeName').textContent = this.dataset.name;
                document.getElementById('complaineeType').textContent = 'Type: ' + (this.dataset.type === 'passenger' ? 'Passenger' : 'Driver');
